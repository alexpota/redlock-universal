 ...
 *
 * NOTE: These tests are skipped in CI environments due to process spawning
 * limitations and Redis connection issues in containerized environments.
 * They run successfully in local development environments.
 */
describe.skipIf(process.env.CI === 'true' || process.env.GITHUB_ACTIONS === 'true')(
  'RedLock Cross-Process Validation',
  () => {
